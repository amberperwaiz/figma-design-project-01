      ...
      <nav className="p-4 w-full">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="text-white text-[20px] md:text-[24px] font-bold">
            ...
            <div className="space-x-4  hidden md:flex mr-4 lg:mr-[450px] ml-4 gap-4 text-[14px] leading-[24px] mt-[16px]">
            <span className="text-[#35A6f0] hover:text-[#cccccc]">Home</span>
            <span className="text-[#35A6f0] hover:text-[#cccccc]">Product</span>
            <span className="text-[#35A6f0] hover:text-[#cccccc]">Pricing</span>
            <span className="text-[#35A6f0] hover:text-[#cccccc]">Contact</span>
          </div>

          
          <div className="space-x-4">
            <span className="text-[#ffffff] text-[14px] hover:text-[#cccccc]">Login</span>
            <button className="bg-[#23A6F0] hover:bg-green-500  text-white px-4 py-2 rounded text-[14px]">
              JOIN US
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center gap-[40px] mt-[104px]">
        <div className="text-center">
          ...
          <div className="flex space-x-4 mt-[40px] justify-center items-center">
            <button className="bg-[#35A6F0] hover:bg-green-500 text-white px-6 py-2 rounded">Get Quote Now</button>
        ...
        <div className="flex flex-wrap justify-center mt-[80px] gap-[30px] mb-[80px]">
          ...
          <div className="bg-white cursor-pointer text-black p-[35px] rounded-lg shadow-md w-full max-w-[328px]">
          ...
          <div className="bg-[#35A6F0] cursor-pointer text-white p-[35px] rounded-lg shadow-md w-full max-w-[328px] ">
